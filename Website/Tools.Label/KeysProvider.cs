...
namespace Tools.Label
{
    public abstract class KeysProvider : IKeysProvider
    {
        ...
        protected string ResourceFolderName { get; }
        ...
        public Keys GetKeys(CultureInfo culture)
        {
            ...
            var keys = InternalGetKeys(languageFileNames.SingleOrDefault(n =>
                n.Contains($"{culture.Name}.yml") || n.Contains($"{culture.Name}.yaml")));
            ...
            if (keys == null)
                throw new FileNotFoundException(
                    $"There are no language files existing in the Resource folder within '{_resourcesAssembly.GetName().Name}' assembly");
