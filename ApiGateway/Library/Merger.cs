            ...
            for (var i = 0; i < pdc1.Count; i++)
            {
                if (typeMergerPolicy == null
                    || (!typeMergerPolicy.IgnoredProperties.Contains(
                        ...
                        & !typeMergerPolicy.UseProperties.Contains(
                            new Tuple<string, string>(values2.GetType().Name, pdc1[i].Name))))
            ...
            for (var i = 0; i < pdc2.Count; i++)
            {
                if (typeMergerPolicy == null
                    || (!typeMergerPolicy.IgnoredProperties.Contains(
                        ...
                        & !typeMergerPolicy.UseProperties.Contains(
                            new Tuple<string, string>(values1.GetType().Name, pdc2[i].Name))))
